...
import wang.com.model.Circle;
import wang.com.model.MoveObject;
import wang.com.model.SineWave;
import wang.com.view.MoveObjectView;
...
public class MoveObjectController {
	...
	public JMenu getMoveObjectMenu(){
		...
		JRadioButtonMenuItem sineWaveItem = new JRadioButtonMenuItem("正弦波动");
		...
		sineWaveItem.addActionListener(
				new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						// TODO Auto-generated method stub
						//
						moveObject = new SineWave();
						moveObjectView.setMoveObject(moveObject);
						moveObject.setView(moveObjectView);
			
						moveObject.setCenter(moveObjectView.getWidth() / 2, moveObjectView.getHeight() / 2);
						//
						varaSlider.setCommonSlider("波速", 20, 40, (int)moveObject.getVara());
						varbSlider.setCommonSlider("频率", 10, 40, (int)moveObject.getVarb());
						varaSlider.setScaleFactor(1);
						varbSlider.setScaleFactor(Math.PI / 180);
